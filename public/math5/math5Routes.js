...
const contentType = 'math5';
const lessonsFilePath = path.join(__dirname, 'math5lessons.json');
const groupsFilePath = path.join(__dirname, 'math5groups.json');
    ...
    fs.readFile(lessonsFilePath, 'utf8', (err, lessonsData) => {
        ...
        fs.readFile(groupsFilePath, 'utf8', (err, groupsData) => {
            ...
            const mainPage = `
                ...
                <main>
                    <h1>Fifth Grade Math Lessons</h1>
                    <div class="lessons-page">
                        ${groupsList}
                    </div>
                </main>
