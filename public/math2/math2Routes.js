...
const contentType = 'math2';
const lessonsFilePath = path.join(__dirname, 'math2lessons.json');
const groupsFilePath = path.join(__dirname, 'math2groups.json');
    ...
    fs.readFile(lessonsFilePath, 'utf8', (err, lessonsData) => {
        ...
        fs.readFile(groupsFilePath, 'utf8', (err, groupsData) => {
            ...
            const mainPage = `
                ...
                <main>
                    <h1>Second Grade Math Lessons</h1>
                    <div class="lessons-page">
                        ${groupsList}
                    </div>
                </main>
