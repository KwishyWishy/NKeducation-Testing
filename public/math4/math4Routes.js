...
const contentType = 'math4';
const lessonsFilePath = path.join(__dirname, 'math4lessons.json');
const groupsFilePath = path.join(__dirname, 'math4groups.json');
    ...
    fs.readFile(lessonsFilePath, 'utf8', (err, lessonsData) => {
        ...
        fs.readFile(groupsFilePath, 'utf8', (err, groupsData) => {
            ...
            const mainPage = `
                ...
                <main>
                    <h1>Fourth Grade Math Lessons</h1>
                    <div class="lessons-page">
                        ${groupsList}
                    </div>
                </main>
